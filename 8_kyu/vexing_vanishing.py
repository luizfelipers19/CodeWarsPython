...
# even though you can clearly see, that the list should have the right values in it! 
# Somehow, the values are simply disappearing! Is this a bug in the programming language itself...?
...
def mul_by_n(lst, n):
    print("Inputs: ", lst, n) # Check our inputs
    result = [x * n for x in lst] # involved this line with brackets in order to build a list directly to be returned
